...
#define FROM    "<rssmailbot@gmail.com>"
#define TO      "<daniel.nara@outlook.com>"
#define CC      "<daniel.nara@outlook.com>"
...
void sendEmail(std::vector<settings>& map, std::vector<short> send, bool verbose)
{
    ...
    if(curl) 
    {
      ...
      curl_easy_setopt(curl, CURLOPT_USERNAME, "rssmailbot@gmail.com");
